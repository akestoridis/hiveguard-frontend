 ...
 * hiveguard-frontend/src/components/segments/ArchivedAlerts.jsx
 * @license Apache-2.0
 */
...
function ArchivedAlerts({ dataURL }) {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await fetch(`${dataURL}?archived=true`);
      if (
        response.ok
...
ArchivedAlerts.propTypes = {
  dataURL: PropTypes.string,
};

ArchivedAlerts.defaultProps = {
  dataURL: null,
};
